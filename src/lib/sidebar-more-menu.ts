...
export const SIDEBAR_MORE_MENU_PANEL =
    'flex w-full flex-col items-stretch rounded-xl border border-border bg-popover p-1.5 text-popover-foreground shadow-[0_16px_48px_-12px_rgba(0,0,0,0.55)] ring-1 ring-foreground/[0.08]'
